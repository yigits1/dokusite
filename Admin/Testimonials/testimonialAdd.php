            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Referans Ekleme</h3>
                    </div>
                    <form method="post" action="testimonial_post.php">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Ünvanı ...">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="testimonialList.php" class="btn btn-info">İptal</a>
                        </div>
                    </form>
                </div>
            </div>
